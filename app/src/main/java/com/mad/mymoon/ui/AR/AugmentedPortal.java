...
public class AugmentedPortal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StorageReference modelRef = storage.getReference().child("EarthAndMoon.glb");
//        StorageReference modelRef = storage.getReference().child("Portal.glb");
        ...
        findViewById(R.id.downloadBtn)
                .setOnClickListener(v -> {
                    ...
                    try {
                        File file = File.createTempFile("EarthAndMoon", "glb");
//                        File file = File.createTempFile("Portal", "glb");
                        buildModel(file);
