...
public class FactAdapter extends RecyclerView.Adapter<FactAdapter.Viewholder> {
    ...
    // Constructor
    public FactAdapter(Context context, ArrayList<FactModel> factModelArrayList) {
        this.context = context;
        this.factModelArrayList = factModelArrayList;
    }
    ...
    public void onBindViewHolder(@NonNull FactAdapter.Viewholder holder, int position) {
        ...
        FactModel model = factModelArrayList.get(position);
...
//        holder.voiceBtn.setBackground(Drawable.createFromPath("@drawable/ic_newgame"));
    ...
    public int getItemCount() {
        ...
        return factModelArrayList.size();
    }
